...
from .zero_shot_edittingCopy import zero_shot_eval
...
def evaluate(model, data, epoch, args, tb_writer=None):
    ...
    if 'val' in data and (args.val_frequency and ((epoch % args.val_frequency) == 0 or epoch == args.epochs)):
        ...
        with torch.no_grad():
            print(samples_per_val)
            for i, batch in enumerate(dataloader):
                images, texts = batch

                # take only the fifth image
                images = images[::5]
            ...
            # torch.save(image_features, '/share/data/pals/kevin/open_clip/src/feature_embeddings/redcaps_embeddings/image_redcaps_coco_epoch60.pt')
            # # save text features to disk
            # torch.save(text_features, '/share/data/pals/kevin/open_clip/src/feature_embeddings/redcaps_embeddings/text_redcaps_coco_epoch60.pt')
